package com.example.ChatwithDialogflow.View;
...
//        graduationPaint.setTextSize(Utils.convertDpToPixel(GRADUATION_TEXT_SIZE, getContext()));
        graduationPaint.setTextSize(GRADUATION_TEXT_SIZE * getContext().getResources().getDisplayMetrics().density);
//        graduationPaint.setTextSize(GRADUATION_TEXT_SIZE);
